...
Во время записи экрана создать простое приложение (Flutter / React Native на выбор) со следующим функционалом:
...
Обязательная часть — использование нейросети В процессе записи экрана обязательно показать, как ты используешь любые нейросети для: генерации части кода,
...
Что прислать Видео (скринкаст) с выполнением задания (любой формат: mp4, mov, запись экрана Mac).
...
Как мы оцениваем Умение мыслить и объяснять решения.
